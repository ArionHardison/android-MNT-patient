package com.comida.user.adapter;
...
import com.comida.user.activities.HotelViewActivity;
import com.comida.user.activities.LoginActivity;
import com.comida.user.activities.ProductDetailActivity;
import com.comida.user.activities.ViewCartActivity;
import com.comida.user.build.api.ApiClient;
import com.comida.user.build.api.ApiInterface;
import com.comida.user.fragments.CartChoiceModeFragment;
...
import static com.comida.user.helper.GlobalData.notificationCount;
import static com.comida.user.helper.GlobalData.profileModel;
import static com.comida.user.helper.GlobalData.selectedShop;
