...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.pakupaku.user.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.pakupaku.user.models.Address();
...
//                .addApi(Places.GEO_DATA_API)
    ...
    private void saveAddress(String update) {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.pakupaku.user.models.Address> call = apiInterface.saveAddress(address, update);
            call.enqueue(new Callback<com.pakupaku.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.pakupaku.user.models.Address> call, @NonNull Response<com.pakupaku.user.models.Address> response) {
...
//                        Toast.makeText(SaveDeliveryLocationActivity.this, error.getType().get(0), Toast.LENGTH_SHORT).show();
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.pakupaku.user.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.pakupaku.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.pakupaku.user.models.Address> call, @NonNull Response<com.pakupaku.user.models.Address> response) {
                    customDialog.dismiss();
