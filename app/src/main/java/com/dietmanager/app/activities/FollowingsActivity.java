...
public class FollowingsActivity extends AppCompatActivity implements DietitianListAdapter.IDietitianListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.toolbar).findViewById(R.id.title)).setText(R.string.followings);
...
/*        mNestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
    ...
    public void onDietitianClicked(DietitianListItem dietitianListItem) {
        Intent intent=new Intent(FollowingsActivity.this,DietitianDetailedActivity.class);
    ...
    private void getFollowingsList() {
        customDialog.show();
        Call<List<DietitianListItem>> call = apiInterface.getFollowingsList();
        call.enqueue(new Callback<List<DietitianListItem>>() {
            ...
            public void onFailure(Call<List<DietitianListItem>> call, Throwable t) {
                ...
                if (customDialog.isShowing())
                    customDialog.dismiss();
                Utils.displayMessage(FollowingsActivity.this, FollowingsActivity.this, getString(R.string.something_went_wrong));
            }
        });
    }
