package com.eataround.app.activities;
...
import com.eataround.app.build.api.APIError;
import com.eataround.app.build.api.ApiClient;
import com.eataround.app.build.api.ApiInterface;
import com.eataround.app.build.api.ErrorUtils;
import com.eataround.app.helper.CustomDialog;
...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.eataround.app.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.eataround.app.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.eataround.app.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.eataround.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.eataround.app.models.Address> call, @NonNull Response<com.eataround.app.models.Address> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<com.eataround.app.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.eataround.app.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.eataround.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.eataround.app.models.Address> call, @NonNull Response<com.eataround.app.models.Address> response) {
                    customDialog.dismiss();
