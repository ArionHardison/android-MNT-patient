package com.dalejoak.app.activities;
...
import com.dalejoak.app.build.api.APIError;
import com.dalejoak.app.build.api.ApiClient;
import com.dalejoak.app.build.api.ApiInterface;
import com.dalejoak.app.build.api.ErrorUtils;
import com.dalejoak.app.helper.CustomDialog;
...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.dalejoak.app.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.dalejoak.app.models.Address();
...
//                .addApi(Places.GEO_DATA_API)
    ...
    private void saveAddress(String update) {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.dalejoak.app.models.Address> call = apiInterface.saveAddress(address, update);
            call.enqueue(new Callback<com.dalejoak.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.dalejoak.app.models.Address> call, @NonNull Response<com.dalejoak.app.models.Address> response) {
...
//                        Toast.makeText(SaveDeliveryLocationActivity.this, error.getType().get(0), Toast.LENGTH_SHORT).show();
                ...
                @Override
                public void onFailure(@NonNull Call<com.dalejoak.app.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.dalejoak.app.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.dalejoak.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.dalejoak.app.models.Address> call, @NonNull Response<com.dalejoak.app.models.Address> response) {
                    customDialog.dismiss();
