package com.tringtwentyfour.app;
...
import com.tringtwentyfour.app.fragments.CartFragment;
import com.tringtwentyfour.app.fragments.HomeFragment;
import com.tringtwentyfour.app.fragments.ProfileFragment;
import com.tringtwentyfour.app.fragments.SearchFragment;
...
import static com.tringtwentyfour.app.helper.GlobalData.notificationCount;
import static com.tringtwentyfour.app.helper.GlobalData.profileModel;
...
public class HomeActivity extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AHBottomNavigationItem item3 = new AHBottomNavigationItem(R.string.bottom_nav_cart, R.drawable.ic_shopping_cart, R.color.grey);
        AHBottomNavigationItem item4 = new AHBottomNavigationItem(R.string.nav_bottom_profile, R.drawable.ic_account_circle, R.color.grey);
        // Add items
...
// Change colors
        ...
        bottomNavigation.setInactiveColor(ContextCompat.getColor(this,R.color.colorSecondaryText));
