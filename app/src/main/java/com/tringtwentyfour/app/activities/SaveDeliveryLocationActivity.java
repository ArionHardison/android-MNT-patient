package com.tringtwentyfour.app.activities;
...
import com.tringtwentyfour.app.build.api.APIError;
import com.tringtwentyfour.app.build.api.ApiClient;
import com.tringtwentyfour.app.build.api.ApiInterface;
import com.tringtwentyfour.app.build.api.ErrorUtils;
import com.tringtwentyfour.app.helper.CustomDialog;
...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.tringtwentyfour.app.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.tringtwentyfour.app.models.Address();
...
//                .addApi(Places.GEO_DATA_API)
    ...
    private void saveAddress(String update) {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.tringtwentyfour.app.models.Address> call = apiInterface.saveAddress(address, update);
            call.enqueue(new Callback<com.tringtwentyfour.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.tringtwentyfour.app.models.Address> call, @NonNull Response<com.tringtwentyfour.app.models.Address> response) {
...
//                        Toast.makeText(SaveDeliveryLocationActivity.this, error.getType().get(0), Toast.LENGTH_SHORT).show();
                ...
                @Override
                public void onFailure(@NonNull Call<com.tringtwentyfour.app.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.tringtwentyfour.app.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.tringtwentyfour.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.tringtwentyfour.app.models.Address> call, @NonNull Response<com.tringtwentyfour.app.models.Address> response) {
                    customDialog.dismiss();
