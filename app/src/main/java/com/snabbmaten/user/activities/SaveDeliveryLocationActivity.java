...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.snabbmaten.user.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.snabbmaten.user.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress(String update) {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.snabbmaten.user.models.Address> call = apiInterface.saveAddress(address, update);
            call.enqueue(new Callback<com.snabbmaten.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.snabbmaten.user.models.Address> call, @NonNull Response<com.snabbmaten.user.models.Address> response) {
...
//                        Toast.makeText(SaveDeliveryLocationActivity.this, error.getType().get(0), Toast.LENGTH_SHORT).show();
                ...
                @Override
                public void onFailure(@NonNull Call<com.snabbmaten.user.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.snabbmaten.user.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.snabbmaten.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.snabbmaten.user.models.Address> call, @NonNull Response<com.snabbmaten.user.models.Address> response) {
                    customDialog.dismiss();
