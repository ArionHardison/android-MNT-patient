package com.orderaround.user.adapter;
...
import com.orderaround.user.activities.HotelViewActivity;
import com.orderaround.user.activities.LoginActivity;
import com.orderaround.user.activities.ProductDetailActivity;
import com.orderaround.user.activities.ViewCartActivity;
import com.orderaround.user.build.api.ApiClient;
import com.orderaround.user.build.api.ApiInterface;
import com.orderaround.user.fragments.CartChoiceModeFragment;
...
import com.orderaround.user.models.Product;
...
import static com.orderaround.user.helper.GlobalData.notificationCount;
import static com.orderaround.user.helper.GlobalData.profileModel;
import static com.orderaround.user.helper.GlobalData.selectedShop;
