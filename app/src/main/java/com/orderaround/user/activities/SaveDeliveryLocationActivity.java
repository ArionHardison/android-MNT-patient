package com.orderaround.user.activities;
...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.orderaround.user.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.orderaround.user.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.orderaround.user.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.orderaround.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.orderaround.user.models.Address> call, @NonNull Response<com.orderaround.user.models.Address> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<com.orderaround.user.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.orderaround.user.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.orderaround.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.orderaround.user.models.Address> call, @NonNull Response<com.orderaround.user.models.Address> response) {
                    customDialog.dismiss();
