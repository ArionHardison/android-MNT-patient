...
import com.geteat.user.adapter.OrderFlowAdapter;
import com.geteat.user.build.api.ApiClient;
import com.geteat.user.build.api.ApiInterface;
import com.geteat.user.fragments.OrderViewFragment;
import com.geteat.user.helper.CustomDialog;
import com.geteat.user.helper.DataParser;
...
import com.geteat.user.models.OrderFlow;
...
import static com.geteat.user.helper.GlobalData.ORDER_STATUS;
import static com.geteat.user.helper.GlobalData.isSelectedOrder;
