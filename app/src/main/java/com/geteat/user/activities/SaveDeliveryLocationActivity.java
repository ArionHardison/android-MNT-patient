...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.geteat.user.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.geteat.user.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            call.enqueue(new Callback<com.geteat.user.models.Address>() {
                ...
                @Override
                public void onFailure(@NonNull Call<com.geteat.user.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.geteat.user.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.geteat.user.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.geteat.user.models.Address> call, @NonNull Response<com.geteat.user.models.Address> response) {
                    customDialog.dismiss();
